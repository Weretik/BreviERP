    ...
    where TId : struct
{
    ...
    public void Rename(string name, DateTime at)
    {
        SetName(name);
        MarkAsUpdated(at);
    }
    public void Repath(LTree newPath, DateTime at)
    {
        SetPath(newPath);
        MarkAsUpdated(at);
    }
    public void AddChild(TSelf child, DateTime updatedDate)
    {
    ...
    public void RemoveChild(TSelf child, DateTime updatedDate)
    {
        child = Guard.Against.Null(child, nameof(child));
    ...
    public void MoveTo(TId? newParentId, DateTime updatedDate)
    {
