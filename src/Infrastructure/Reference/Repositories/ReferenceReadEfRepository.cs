...
internal sealed class ReferenceReadEfRepository<T>(IDbContextFactory<ReferenceDbContext> factory)
    : IReferenceReadRepository<T>
    where T : class, IAggregateRoot
{
        ...
        Func<IRepositoryBase<T>, Task<TResult>> action, CancellationToken ct)
    {
        ...
        var repo = new ReferenceEfRepository<T>(db);
